...
public class CesdvTestContainer extends TestContainer {

    public CesdvTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/cesdv/app.properties",
    ...
    public static class Common extends CesdvTestContainer {

        public static final CesdvTestContainer.Common INSTANCE = new CesdvTestContainer.Common();
